...
import com.backbase.dbs.batch.service.v2.service.ApiClient;
...
@ContextScoped
@Configuration
public class BatchOrderServiceClientConfig extends BaseConfig{
    ...
    @Bean("serviceBatchOrderAPi")
    @Primary
    public BatchOrdersApi serviceBatchOrderAPi() {
