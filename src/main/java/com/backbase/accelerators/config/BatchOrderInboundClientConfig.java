...
import com.backbase.dbs.batch.inbound.v2.service.ApiClient;
...
@ContextScoped
@Configuration
public class BatchOrderInboundClientConfig extends BaseConfig{


    private static final String PAYMENT_BATCH_SERVICE_ID = "payment-batch";
    ...
    @Bean("inboundBatchOrderAPi")
    @Primary
    public BatchOrdersApi inboundBatchOrderAPi() {
